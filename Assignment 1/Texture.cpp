...
cv::Vec3b Texture::texture_lookup_bilinear(const Vec2& uv) {
    ...
    cv::Vec3b pixelColor;    
    pixelColor[0] = bound(au * av * pixel00[0] + au * bv * pixel01[0] + bu * av * pixel10[0] + bu * bv * pixel11[0]);
    pixelColor[1] = bound(au * av * pixel00[1] + au * bv * pixel01[1] + bu * av * pixel10[1] + bu * bv * pixel11[1]);
    pixelColor[2] = bound(au * av * pixel00[2] + au * bv * pixel01[2] + bu * av * pixel10[2] + bu * bv * pixel11[2]);
